...
echo "========================================"
echo "  Voxy one-click mod build - macOS"
echo "========================================"
echo

if ! command -v java >/dev/null 2>&1; then
    echo "[ERROR] Java was not found in PATH." >&2
    echo "Install JDK 25 or newer and set JAVA_HOME/PATH, then run this file again." >&2
    exit 1
fi
...
if [[ ! -f ./gradlew ]]; then
    echo "[ERROR] ./gradlew was not found. Keep this .command file in the Voxy repository root." >&2
    exit 1
fi
